...
To mitigate this, it is recommended to check OpenGPG fingerprint from multiple "secure" sites. Bonus points for using different authentication systems. For example:
