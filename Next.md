...
(And/)or create a file /etc/whonix.d/50_aptrepository_user.
    ...
    sudo nano /etc/whonix.d/50_aptrepository_user
...
128 MB RAM for Whonix-Gateway without graphical desktop environment
768 MB RAM for Whonix-Gateway with graphical desktop environment

128 MB RAM for Whonix-Workstation without graphical desktop environment
768 MB RAM for Whonix-Workstation with graphical desktop environment
