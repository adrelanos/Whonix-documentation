...
The [https://wiki.debian.org/Derivatives/Guidelines Debian Derivatives Guidelines] encourages &quot;derivative distributions to mention and define their relationship with Debian&quot;. Because this seems like a great idea to me, I wrote this statement that not only covers Whonix's relationship with Debian, but also Whonix's relationship with any one of its upstream projects.
...
[http://wiki.debian.org/Derivatives/Census/Whonix Whonix participates in the Derivatives Census.]
...
See [https://sourceforge.net/p/whonix/wiki/OperatingSystem/#about-debian About Debian] for reasons to choose Wheezy. When Wheezy gets stable, Whonix will be based on stable. Depending on user feedback Whonix will remain based on stable. Depending on user feedback and stability of testing, Whonix might be based on testing.
...
Not installed in Whonix. Reasons are in the [https://sourceforge.net/p/whonix/wiki/OperatingSystem/#popularity-contest Popularity Contest] chapter.
...
<pre>Whonix RelationshipWithUpstream wiki page Copyright (C) Amnesia &lt;amnesia at boum dot org&gt;
Whonix RelationshipWithUpstream wiki page Portions Copyright (C) 2012 adrelanos &lt;adrelanos at riseup dot net&gt;
